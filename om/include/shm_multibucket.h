...
#ifndef __SHM_MULTIBUCKET_H_
#define __SHM_MULTIBUCKET_H_
...
class MultiBucket {
    ...
    public:
        MultiBucket (node_pool_t* pnode_pool)
        ...
        template <typename _Params, typename _Modifier>
        inline bool remove(const sig_t &sig, const key_t &key, _Params &params, _Modifier &action) {
            m_lock.ns_write_lock();
